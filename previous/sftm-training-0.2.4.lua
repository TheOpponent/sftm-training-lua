---/Street Fighter: The Movie training lua v.0.2.4 (2021/07/22)/---
...
local footsiesconfig = {
	...
	attack1button = {{"LP", "MP", "HP", "LK", "MK", "HK", "slot1", "slot2", "slot3", "slot4", "slot5"}, 6},
	attack1distance = 80,
	...
	attack2button = {{"LP", "MP", "HP", "LK", "MK", "HK", "slot1", "slot2", "slot3", "slot4", "slot5"}, 7},
	attack2distance = 170,
...
local function footsies()
	...
	luaconfig.showmenu[2] = 2
	--get status
	P1status.x, P1status.y, P1status.dir = rws(0x70F0), rws(0x70F2), rbs(0x7133)
	P2status.x, P2status.y, P2status.dir = rws(0x740E), rws(0x7410), rbs(0x72F5)
	...
	local charadir = 0
	if not inputconfig.ifswapinput[1][inputconfig.ifswapinput[2]] then
		if P2status.dir == 2 then
			charadir = "left"
		elseif P2status.dir == 0 then
			charadir = "right"
		end
	elseif inputconfig.ifswapinput[1][inputconfig.ifswapinput[2]] then
		if P1status.dir == 2 then
			charadir = "left"
		elseif P1status.dir == 0 then
			charadir = "right"
		end
	end
	...
	elseif footsiesconfig.movetype[1][footsiesconfig.movetype[2]] == "attack" then
		if footsiesconfig.attackmode[1][footsiesconfig.attackmode[2]] == "normal" then
			...
			if footsiesconfig.attackbutton[1][footsiesconfig.attackbutton[2]] == "LP" then
				table.insert(inp, #inp+1, "Weak Punch")
			elseif footsiesconfig.attackbutton[1][footsiesconfig.attackbutton[2]] == "MP" then
				table.insert(inp, #inp+1, "Medium Punch")
			elseif footsiesconfig.attackbutton[1][footsiesconfig.attackbutton[2]] == "HP" then
				table.insert(inp, #inp+1, "Strong Punch")
			elseif footsiesconfig.attackbutton[1][footsiesconfig.attackbutton[2]] == "LK" then
				table.insert(inp, #inp+1, "Weak Kick")
			elseif footsiesconfig.attackbutton[1][footsiesconfig.attackbutton[2]] == "MK" then
				table.insert(inp, #inp+1, "Medium Kick")
			elseif footsiesconfig.attackbutton[1][footsiesconfig.attackbutton[2]] == "HK" then
				table.insert(inp, #inp+1, "Strong Kick")
			end
		elseif footsiesconfig.attackmode[1][footsiesconfig.attackmode[2]] == "playback" then
...
local function getmenuinput()
	...
	if recordconfig.previousrecordstate then
		...
		menuconfig.menuinput.P1.currentinput["Weak Punch"] = true
		menuconfig.menuinput.P1.currentinput["Button 2"] = true
		menuconfig.menuinput.P1.currentinput["Medium Punch"] = true
		menuconfig.menuinput.P1.currentinput["Button 3"] = true
		menuconfig.menuinput.P1.currentinput["Strong Punch"] = true
		...
		menuconfig.menuinput.P2.currentinput["Weak Punch"] = true
		menuconfig.menuinput.P2.currentinput["Button 2"] = true
		menuconfig.menuinput.P2.currentinput["Medium Punch"] = true
		menuconfig.menuinput.P2.currentinput["Button 3"] = true
		menuconfig.menuinput.P2.currentinput["Strong Punch"] = true
	...
	if luaconfig.showmenu[1][luaconfig.showmenu[2]] then
		...
		if not recordconfig.previousrecordstate then --not works after recording
			...
			if menuconfig.menuinput.P1.currentinput["Strong Punch"]  or menuconfig.menuinput.P1.currentinput["Button 3"] or menuconfig.menuinput.P2.currentinput["Strong Punch"] or menuconfig.menuinput.P2.currentinput["Button 3"] then
	...
	elseif not luaconfig.showmenu[1][luaconfig.showmenu[2]] then
		if not recordconfig.ifrecording[1][recordconfig.ifrecording[2]] and not recordconfig.ifplayback[1][recordconfig.ifplayback[2]] and not footsiesconfig.iffootsies[1][footsiesconfig.iffootsies[2]] then --works when not recording and playback and footsies
			--P1 inputs (close)
...
local function updatemenu()
	...
	menuconfig.menupage[1].submenupage[5].submenuoption = { --set submenu option(s)
		...
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+120, text = "display playback: "..menuifshowplayback[1][menuifshowplayback[2]],
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
			leftfunc = function()
		...
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+144, text = "back to main menu",
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
			buttonfunc = function()
	...
	menuconfig.menupage[1].submenupage[6].submenuoption = { --set submenu option(s)
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+8, text = "show HUD: "..menuifshowhud[1][menuifshowhud[2]],
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
			leftfunc = function()
		...
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+32, text = "show input: "..menuifshowinput[1][menuifshowinput[2]],
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
			leftfunc = function()
		...
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+48, text = "back to main menu",
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
			buttonfunc = function()
	...
	menuconfig.menupage[1].submenupage[8].boxconfig = { --subpage box config
		bgcolor = 0xc7c7d1ee,
		frcolor = 0x52527aff,
		notebgcolor = 0xc7d1d1ee,
		notefrcolor = 0x527a7aff,
	...
	menuconfig.menupage[1].submenupage[8].textconfig = { --subpage text config
		textleft = cd.boxconfig.boxleft+16,
		texttop = cd.boxconfig.boxtop+16,
		textcol1 = 0xffffffff,
		textcol2 = 0x000000ff,
