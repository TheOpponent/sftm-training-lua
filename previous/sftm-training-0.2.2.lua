---/Street Fighter: The Movie training lua v.0.2.2 (2021/07/02)/---
...
function iffileexist(name) --check if the file exists (name: the file name)
...
local recordconfig = {
	...
	deleteslot = 1,
	playbackslot = 1,
	playbackstyle = {{"once", "repeat", "random"}, 2},
	playbacktime = 1,
	playbackinput = {},
...
local function getmenuinput()
	...
	if inputconfig.ifholdinputset[1][inputconfig.ifholdinputset[2]] then
		if not inputconfig.ifswapinput[1][inputconfig.ifswapinput[2]] then
			if inputconfig.holdinputplayer[1][inputconfig.holdinputplayer[2]] == "P1" then
				...
				menuconfig.menuinput.P1.currentinput["Coin"] = false
			elseif inputconfig.holdinputplayer[1][inputconfig.holdinputplayer[2]] == "P2" then
				...
				menuconfig.menuinput.P2.currentinput["Coin"] = false
			end
		elseif inputconfig.ifswapinput[1][inputconfig.ifswapinput[2]] then
			if inputconfig.holdinputplayer[1][inputconfig.holdinputplayer[2]] == "P1" then
				menuconfig.menuinput.P2.currentinput["Up"] = false
	...
	if recordconfig.previousrecordstate then
		menuconfig.menuinput.P1.currentinput["Button 1"] = true
		menuconfig.menuinput.P1.currentinput["Button 2"] = true
		...
		menuconfig.menuinput.P2.currentinput["Button 1"] = true
		menuconfig.menuinput.P2.currentinput["Button 2"] = true
	...
	elseif not luaconfig.showmenu[1][luaconfig.showmenu[2]] then
		if not recordconfig.ifrecording[1][recordconfig.ifrecording[2]] and not recordconfig.ifplayback[1][recordconfig.ifplayback[2]] then --works when not recording and playback
			--P1 inputs (close)
	...
	if recordconfig.ifrecording[1][recordconfig.ifrecording[2]] and recordconfig.timerbeforerecording ~= 0 then
		if (menuconfig.menuinput.P1.currentinput["Coin"] and not menuconfig.menuinput.P1.previousinput["Coin"]) or (menuconfig.menuinput.P1.currentinput["Coin"] and not menuconfig.menuinput.P1.previousinput["Coin"])
		 or (menuconfig.menuinput.P2.currentinput["Coin"] and not menuconfig.menuinput.P2.previousinput["Coin"]) or (menuconfig.menuinput.P2.currentinput["Coin"] and not menuconfig.menuinput.P2.previousinput["Coin"]) then --set the function of coin in menu page
			 recordconfig.ifrecordend[2] = 1
		end
	end
	--menu input (playback)
...
local function displaymenu()
	...
	menuconfig.menupage[1].menutext = { -- set menu text(s)
		...
		{x = cd.textconfig.textleft, y = cd.textconfig.texttop+88, text = "- menu -", textcol1 = 0xb6fbd8ff, textcol2 = cd.textconfig.textcol2}
	}
	...
	menuconfig.menupage[1].submenupage[1].submenutext = { --set submenu text(s)
		...
		{x = cd.textconfig.textleft, y = cd.textconfig.texttop+16, text = "* general", textcol1 =  0xb6fbd8ff, textcol2 = cd.textconfig.textcol2},
		{x = cd.textconfig.textleft, y = cd.textconfig.texttop+40, text = "* Player 1", textcol1 =  0xb6fbd8ff, textcol2 = cd.textconfig.textcol2},
		{x = cd.textconfig.textleft, y = cd.textconfig.texttop+80, text = "* Player 2", textcol1 =  0xb6fbd8ff, textcol2 = cd.textconfig.textcol2}
	}
	...
	menuconfig.menupage[1].submenupage[2].submenutext = { --set submenu text(s)
		{x = cd.textconfig.textleft, y = cd.textconfig.texttop, text = "- basic setting -", textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2},
		{x = cd.textconfig.textleft, y = cd.textconfig.texttop+16, text = "* input", textcol1 = 0xb6fbd8ff, textcol2 = cd.textconfig.textcol2},
	}
	...
	menuconfig.menupage[1].submenupage[5].boxconfig = { --submenu box config
		...
		boxwidth = sw*0.55,
		boxheight = sh*0.70,
		boxleft = (sw-sw*0.55)*0.5+sw*0.05,
	...
	menuconfig.menupage[1].submenupage[5].submenutext = { --set submenu text(s)
		...
		{x = cd.textconfig.textleft, y = cd.textconfig.texttop+16, text = "* savestate", textcol1 = 0xb6fbd8ff, textcol2 = cd.textconfig.textcol2},
		{x = cd.textconfig.textleft, y = cd.textconfig.texttop+64, text = "* recording", textcol1 = 0xb6fbd8ff, textcol2 = cd.textconfig.textcol2},
		{x = cd.textconfig.textleft, y = cd.textconfig.texttop+72, text = "[ recorded slot(s): "..table.concat(menurecordedslot, ", ").." ]", textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2},
		{x = cd.textconfig.textleft, y = cd.textconfig.texttop+112, text = "* playback", textcol1 = 0xb6fbd8ff, textcol2 = cd.textconfig.textcol2}
	}
	menuconfig.menupage[1].submenupage[5].submenuoption = { --set submenu option(s)
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+24, text = "save the current state "..menuifsavestateexist[1][menuifsavestateexist[2]], note = "Press Start to save.",
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
		...
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+32, text = "load the saved state", note = "Press Start to load.",
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
			buttonstartfunc = function()
				if iffileexist(emu.romname().."_recording.fs") then
					savestate.load(savestate.create(emu.romname().."_recording.fs"))
		...
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+40, text = "delete the saved state", note = "Press Start to delete.",
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
			buttonstartfunc = function()
				if iffileexist(emu.romname().."_recording.fs") then
					os.rename(emu.romname().."_recording.fs", emu.romname().."_recording.fs.backup")
					os.remove(emu.romname().."_recording.fs")
				end
			end
		},
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+48, text = "load the state before recording/playback: "..recordconfig.ifloadstatebefore[1][recordconfig.ifloadstatebefore[2]],
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
			leftfunc = function()
		...
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+80, text = "frame(s) before recording: "..recordconfig.framebeforerecording,
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
			leftfunc = function()
		...
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+88, text = "record slot: "..recordconfig.recordslot, note = "Press button1/Start to start recording. Press coin to stop recording",
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
			leftfunc = function()
		...
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+96, text = "delete recorded slot: "..recordconfig.deleteslot, note = "Press button1/Start to delete recording.",
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
			leftfunc = function()
		...
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+120, text = "playback style: "..recordconfig.playbackstyle[1][recordconfig.playbackstyle[2]],
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
			leftfunc = function()
		...
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+128, text = "display playback: "..menuifshowplayback[1][menuifshowplayback[2]],
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
			leftfunc = function()
		...
		{
			x = cd.textconfig.textleft, y = cd.textconfig.texttop+136, text = "playback slot: "..recordconfig.playbackslot, note = "Press button1/Start to start playback. Press coin to stop playback",
			textcol1 = cd.textconfig.textcol1, textcol2 = cd.textconfig.textcol2, textselectedcol1 = cd.textconfig.textselectedcol1, textselectedcol2 = cd.textconfig.textselectedcol2, textnotecol1 = cd.textconfig.textnotecol1, textnotecol2 = cd.textconfig.textnotecol2,
			leftfunc = function()
